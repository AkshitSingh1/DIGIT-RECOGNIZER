...
def screen_capture():
   ...
   import time
   import os
   os.startfile("C:\Program Files\WindowsApps\Microsoft.Paint_11.2304.33.0_x64__8wekyb3d8bbwe\PaintApp\mspaint.exe")
   s1=t1.get()
   os.chdir("C:/Users/akshi/OneDrive/Desktop/Python/imgstore")
   os.mkdir(s1)
   os.chdir("C:/Users/akshi/OneDrive/Desktop/Python/untitled folder")
  
   images_folder="imgstore/"+s1+"/"
   time.sleep(15)
   for i in range(0,5):
       time.sleep(8)
